...
// // Pra usar sysexec eu teria que substituir o exec ali de baixo...
// //      ... e se pah ja ta certo, sei la.
// //  TODO: se acabar sem usar sysexec tem que remover todas as referencias
// // extern "C" { void _sysexec(void *); }
